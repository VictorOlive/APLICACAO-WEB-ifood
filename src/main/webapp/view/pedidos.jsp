...
<body>
    <div class="dashboard-container">
            ...
            <nav class="aside-menu">
                <div class="aside-menu-items menu-active">
                    <div class="aside-menu-items-icon">
                        <svg class="menu-icon-active" width="22" height="26" viewBox="0 0 22 26" fill="#3E3E3E" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="view/pedidos.jsp">Pedidos</a>
                </div>
                ...
                <div class="aside-menu-items">
                    ...
                    <a href="view/fornecedores.jsp">Fornecedores</a>
                </div>

                <div class="aside-menu-items">
                    <div class="aside-menu-items-icon">
                        <svg width="30" height="21" viewBox="0 0 30 21" fill="#3E3E3E" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="view/entregas.jsp">Entregas</a>
                </div>
            </nav>
        </aside>
        ...
        <main class="main">
            <h1>Pedidos</h1>
            <p>Veja aqui os pedidos feitos em seu restaurante. Nesta página você também pode cancelar pedidos.</p>
            ...
            <section class="card">
                ...
                <div class="card-items">
                    <div class="card-pedidos">
                        ...
                        <div class="card-pedidos-dados">
                            <span class="card-pedidos-dados-1">33</span>
                            <span class="card-pedidos-dados-2">pedidos</span>
                        </div>
                    </div>
    
                    <div class="media-pedidos">
                        <h3>Média de capacidade de pedidos atendidos por hora</h3>
    
                        <select class="selectStyle" name="">
                            <option value="AC">0 - 19 pedidos</option>
                            <option value="AL">20 - 35 pedidos</option>
                            <option value="AP">36 - 50 pedidos</option>
                            <option value="AM">51 - 65 pedidos</option>
                            <option value="BA">66 - 80 pedidos</option>
                            <option value="CE">81 - 95 pedidos</option>
                            <option value="DF">96 - 110 pedidos</option>
                        </select>
                    </div>
                </div>
            </section>

            <section class="card card-fechamento-pedidos">
                <h2>Fechamento automático do recebimento de pedidos</h2>

                <div class="card-fechamento">
                    <p>Selecione essa opção se quiser que a plataforma feche temporariamente o recebimento de pedidos quando sua capacidade máxima for atingida.</p>
                ...
                <p>
                  ...
                  <div class="collapse" id="collapseExample">
                    <div class="info-pedidos">
                        <p>
                        - Novos pedidos serão aceitos quando você liberar 10% de sua capacidade máxima.<br>
                        - A qualquer momento você pode desativar essa opção e controlar manualmente se aceita ou não novos pedidos.
                        </p>
                    </div>
                  </div>
            </section>
            ...
            <section class="card">
                ...
                <p>Pedidos não confirmados não aparecerão na tabela.</p>
                ...
                <table>
                    ...
                    <tr class="table-data">
                        <td>8394</td>
                        <td>09/11/2021 19:53</td>
                        <td>ONLINE</td>
                        <td>R$27,90</td>
                        <td>R$0,00</td>
                        <td>-</td>
                        <td class="table-data-detalhes"><a href="">Ver detalhes</a></td>
                    </tr>
