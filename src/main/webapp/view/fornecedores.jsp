...
<body>
            ...
            <nav class="aside-menu">
                <div class="aside-menu-items">
                    <div class="aside-menu-items-icon">
                        <svg class="menu-icon" width="22" height="26" viewBox="0 0 22 26" fill="#3E3E3E" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="aside-menu-items menu-active">
                    <div class="aside-menu-items-icon">
                        <svg class="menu-icon-active" width="30" height="22" viewBox="0 0 30 22" fill="#3E3E3E" xmlns="http://www.w3.org/2000/svg">
    ...
    <main class="main">
        <h1>Fornecedores</h1>
        <p>Lista de fornecedores que possuem os ingredientes selecionados.</p>
        <div class="card">
            <div class="container ingredientes-style">
                <h2>Costela de boi</h2>
                <h2>Corstela de porco</h2>
                <h2>Banco</h2>
                <h2>Acem moido</h2>
        ...
        <div class="card">
            <div class="fornecedor-style">
                <div class="row">
                    <div class="col-3 col-xl-2	">
                        <img src="../assets/img-mercado1.png" alt="">
                    </div>
                    <div class="col-6 col-xl-6 green-dot">
                        <h3>Mercado São Jorge </h3>
                        <p>R. Brejauna, 32 <br> (48) 99659-1241</p>
                        <div class="img-align">
                            <img src="../assets/greendot.png" alt="">
                            <p>Aberto</p>
                        </div>
                    </div>
                    <div class="col-3 col-xl-4 button-align"">
                        <button>
                             Comprar
                        </button>
                    </div>
            ...
            <div class=" fornecedor-line"></div>
                    <div class="fornecedor-style">
                        <div class="row">
                            <div class="col-3 col-xl-2">
                                <img src="../assets/img-mercado2.png" alt="">
                            </div>
                            <div class="col-6 col-xl-6 green-dot">
                                <h3>Angeloni Centro Supermecado </h3>
                                <p>R. Esteves Júnior, 307 <br> (48) 3216-6250</p>
                                <div class="img-align">
                                    <img src="../assets/greendot.png" alt="">
                                    <p>Aberto</p>
                                </div>
                    ...
                    <div class="fornecedor-style">
                        <div class="row">
                            <div class="col-3 col-xl-2">
                                <img src="../assets/img-mercado3.png" alt="">
                            </div>
                            <div class="col-6 col-xl-6 green-dot">
                                <h3>Mercado São Jorge </h3>
                                <p>R. Brejauna, 43 <br> (48) 99659-1241</p>
                                <div class="img-align">
                                    <img src="../assets/reddot.png" alt="">
                                    <p class="reddot-color">Fechado</p>
                                </div>
                            </div>
                            <div class="col-3 col-xl-4 button-align">
                                <button>
